/**
 ...
 Presentation URL path: /wppf/fuseki/index.js
...
_pf19edb768 += /** * include header section */ this.pfb13f3021(pfDataSet.header);
...
_pf19edb768 += '<!-- index entirety template @package CI-WP-PF @subpackage PlannerFw Copyright W3plan Technologies<https://www.w3plan.net/>--><div class="container';
 if (pfConfig.viewGlobal.hasOwnProperty('VIEW_DESIGN') && pfConfig.viewGlobal.VIEW_DESIGN === 'fluid') {
_pf19edb768 += '-fluid';
}
...
_pf19edb768 += pfDataSet.contentMid.havePosts[post].pLink;
_pf19edb768 += '"><img class="post-thumbnail thumbnail_img img-responsive" src="';
_pf19edb768 += pfDataSet.contentMid.havePosts[post].thumbnailUrl;
_pf19edb768 += '" alt="Post thumbnail"><p class="cw-post-title">';
_pf19edb768 += pfDataSet.contentMid.havePosts[post].title;
_pf19edb768 += '</p></a></div>';
}
_pf19edb768 += '<div class="col-md-12 site-pagination">';
_pf19edb768 += pfDataSet.contentMid.thePostsPagination;
_pf19edb768 += '</div>';
} else {
_pf19edb768 += '<div class="col-md-12">';
_pf19edb768 += /* include content-none template */ this.pf61ee9229(pfDataSet.contentMid.contentNone);
_pf19edb768 += '</div>';
}
_pf19edb768 += '</main><!-- #main --></div><!-- #primary --></div><div class="col-md-3';
 if (pfConfig.viewGlobal.hasOwnProperty('VIEW_LAYOUT') && pfConfig.viewGlobal.VIEW_LAYOUT === 'sidebar-content') {
