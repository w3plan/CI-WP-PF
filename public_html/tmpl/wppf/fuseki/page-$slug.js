/**
 ...
 Presentation URL path: /wppf/fuseki/page-$slug.js
...
_pf19edb768 += '"><div id="primary" class="content-area"><main id="main" class="site-main" role="main"><div class="row"><div class="col-md-12"><!-- Add your PlannerFw template code to page-$slug pages --></div></div></main><!-- #main --></div><!-- #primary --></div><div class="col-md-3';
 if (pfConfig.viewGlobal.hasOwnProperty('VIEW_LAYOUT') && pfConfig.viewGlobal.VIEW_LAYOUT === 'sidebar-content') {
