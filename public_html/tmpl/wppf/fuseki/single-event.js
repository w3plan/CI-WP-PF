/**
 ...
 Presentation URL path: /wppf/fuseki/single-event.js
...
_pf19edb768 += '"><div id="primary" class="content-area"><main id="main" class="site-main" role="main"><div class="row"><div class="col-md-12"><style>.evcontentb {margin:30px 20px;} .evtitle {font-weight:bold;} .evslider {width:300px;height:200px;}</style><article id="';
_pf19edb768 += pfDataSet.contentMid.theID;
_pf19edb768 += '"><header class="entry-header">';
_pf19edb768 += pfDataSet.contentMid.theTitle + pfDataSet.contentMid.thumbNail;
_pf19edb768 += '<div style="margin:50px 10px;">';
_pf19edb768 += pfDataSet.contentMid.theContent;
_pf19edb768 += '</div><table border="0"><tr><td><p class="evtitle">Event venue name</p><div class="evcontentb">';
_pf19edb768 += pfDataSet.contentMid.venueName;
_pf19edb768 += '</div></td><td><p class="evtitle">Organizer name</p><div class="evcontentb">';
_pf19edb768 += pfDataSet.contentMid.organizerName;
_pf19edb768 += '</div></td></tr><tr><td><p class="evtitle">Start date and time</p><div class="evcontentb">';
_pf19edb768 += pfDataSet.contentMid.startDatetime;
_pf19edb768 += '</div></td><td><p class="evtitle">End date and time</p><div class="evcontentb">';
_pf19edb768 += pfDataSet.contentMid.endDatetime;
_pf19edb768 += '</div></td></tr><tr><td><p class="evtitle">Event contact phone</p><div class="evcontentb">';
_pf19edb768 += pfDataSet.contentMid.eventPhone;
_pf19edb768 += '</div></td><td><p class="evtitle">Event cost</p><div class="evcontentb">';
_pf19edb768 += pfDataSet.contentMid.eventCost;
_pf19edb768 += '</div></td></tr></table><p class="evtitle">Image slider</p><div class="evcontentb evslider">';
_pf19edb768 += pfDataSet.contentMid.imageSlider;
_pf19edb768 += '</div></header></article></div></div><div class="row"><div class="col-md-12">';
