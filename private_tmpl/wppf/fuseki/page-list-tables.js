/**
 ...
 Presentation URL path: /wppf/fuseki/page-list-tables.js
 Dynamic data: JSON/XML Model
 
 This file was created at 2019-01-24 21:48:40 by PlannerFw Preprocessor
...
var _pf19edb768 = "";
_pf19edb768 += '<div id="content" class="site-content"><div class="container';
 if (pfConfig.viewGlobal.hasOwnProperty('VIEW_DESIGN') && pfConfig.viewGlobal.VIEW_DESIGN === 'fluid') {
_pf19edb768 += '-fluid';
}
...
var _pf19edb768 = "";
_pf19edb768 += '<footer id="colophon" class="site-footer" role="contentinfo"><div class="container';
 if (pfConfig.viewGlobal.hasOwnProperty('VIEW_DESIGN') && pfConfig.viewGlobal.VIEW_DESIGN === 'fluid') {
_pf19edb768 += '-fluid';
}
...
_pf19edb768 += '"><div id="primary" class="content-area"><main id="main" class="site-main" role="main"><div class="row"><div class="col-md-2"></div><div class="col-md-8"><h4 style="margin:30px auto;text-align:center">Display tables of the current database</h4>';
 if (pfDataSet.contentMid.hasOwnProperty('ciwp')) {
_pf19edb768 += '<ul style="margin-left:50px;">';
 var dlen = pfDataSet.contentMid.ciwp.length;var item;for (item = 0;item< dlen;item++) {
_pf19edb768 += '<li>' + pfDataSet.contentMid.ciwp[item] + '</li>';
}
_pf19edb768 += '</ul>';
}
_pf19edb768 += '</div><div class="col-md-2"></div></div></main><!-- #main --></div><!-- #primary --></div><div class="col-md-3';
 if (pfConfig.viewGlobal.hasOwnProperty('VIEW_LAYOUT') && pfConfig.viewGlobal.VIEW_LAYOUT === 'sidebar-content') {
